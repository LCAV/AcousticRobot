...
def send_commands(time_array,command_array,outputf,s):
    ...
    with touchopen(outputf,'wt') as f:
        ...
        for i,t in enumerate(time_array):
            ...
            # adds too much extra time
            #last_time = time.time()-last_time
            last_time = t

def send_commands_wihout_idletimes(time_array, command_array,outputf,s):
    counter = 0
